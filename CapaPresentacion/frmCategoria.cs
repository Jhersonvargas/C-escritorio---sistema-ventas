...
namespace CapaPresentacion
{
    public partial class frmCategoria : Form
    {
        ...
        private void txtbusqueda_TextChanged(object sender, EventArgs e)
        {
            ...
            //categoria.Descripcion = txtbusqueda.Text;

            //// Llama al método para consultar las categorías
            //CN_Categoria.ConsultarCategorias(categoria);

            //// Asigna el resultado al origen de datos del DataGridView
            //dgbusqueda.DataSource = CN_Categoria.ds;
            //dgbusqueda.DataMember = "CargarCategorias";
        }

        private void dgbusqueda_CellParsing(object sender, DataGridViewCellParsingEventArgs e)
        {

        }

        private void dgbusqueda_CellPainting(object sender, DataGridViewCellPaintingEventArgs e)
        {
        ...
        {
            //txtdescripcion.Text = this.dgbusqueda.Rows[e.RowIndex].Cells[1].Value.ToString();
            //cboestado.Text = this.dgbusqueda.Rows[e.RowIndex].Cells[2].Value.ToString();
