...
namespace CapaPresentacion
{
    public partial class frmVentas : Form
    {
        ...
        //-------------------------------------------------
        private decimal tasaIGV = 0.18M; // Puedes ajustar el valor según la tasa de IGV 
        ...
        private void calcularTotal()
        {
            ...
            // Mostrar el total y el IGV en controles
            txttotalpagar.Text = (total+igv).ToString("0.00");
        ...
        private void btncrearventa_Click(object sender, EventArgs e)
        {
            ...
            Venta oVenta = new Venta()
            {
                ...
                MontoIGV = Convert.ToDecimal(lblIGV.Text) // Agrega el monto del IGV
        ...
        private void lblIGV_Click(object sender, EventArgs e)
        {
